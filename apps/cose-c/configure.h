...
#define USE_CONTIKICRYPT

#if defined(USE_MBED_TLS)
#if defined(USE_OPEN_SSL) || defined(USE_BCRYPT) || defined(USE_CONTIKICRYPT)
#error Only Define One Crypto Package
#endif
#elif defined(USE_BCRYPT)
#if defined(USE_OPENSSL) || defined(USE_CONTIKICRYPT)
#error Only Define One Crypto Package
#endif
#elif defined(USE_CONTIKICRYPT)
#if defined(USE_OPEN_SSL)
#error Only Define One Crypto Package
#endif
