...
- otp-node.c: A CoAP client that polls the /actuators/toggle resource
...
1. Change the hard-coded server address in otp-node.c to aaaa::____:____:____:____
2. Connect a third Tmote Sky

        make TARGET=sky otp-node.upload MOTE=3
